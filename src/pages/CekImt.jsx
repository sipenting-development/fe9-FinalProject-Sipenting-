          ...
          <Container className="text-center text-lg-start mt-3 mt-md-5 mb-5">
            ...
            <div className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
              <div className="mb-3 mb-lg-0">
                <p className="ms-0 fs-6 layanan 2">
              ...
              <div className="p-4 text-end ">
                <Link
                  to="/konsultasi"
                  className=" konseling btn rounded-5 px-5 py-2 text-sm-center fs-6 text-white fw-semibold d-inline-block "
                  style={{ backgroundColor: "#54bca4", fontFamily: "Poppins" }}
                >
                  Konseling
                </Link>
              </div>
