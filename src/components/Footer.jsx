                ...
                <div className="mt-3 fw-medium text-white">
                  ...
                  <span>
                    <a className="d-inline-flex ps-2 text-white mb-3 text-decoration-none fs-6" href="mailto:fe9sipenting@gmail.com" target="_blank">
                      fe9sipenting@gmail.com
                    </a>
                  </span>
                  <br />
                  <img src="https://res.cloudinary.com/damsz0xlx/image/upload/v1683201273/Assets/telp_e9see9.png" alt="" />
                  <span>
                    <a className="d-inline-flex ps-2 text-white mb-3 text-decoration-none fs-6" href="https://wa.me/+6285335857254" target="_blank">
                      +6289955000233 (cs)
                    </a>
                  </span>
                  <br />
                  ...
                  <span>
                    <a className="d-inline-flex ps-2 text-white mb-3 text-decoration-none fs-6" href="https://goo.gl/maps/kb2DgYGSnMLzFLQt7" target="_blank">
