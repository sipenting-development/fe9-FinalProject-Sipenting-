...
const DataSection = ({ img, title, cardText1, cardText2 }) => {
  return (
    <>
      <Card className="text-center mb-3" style={{ width: "16rem", height: "16rem", border: "4px solid", borderColor: "#54bca4" }}>
        <Card.Body className="d-flex flex-column align-items-center">
          <Card.Img src={img} alt="" style={{ maxWidth: "70px", maxHeight: "70px" }} className="mb-3" />
