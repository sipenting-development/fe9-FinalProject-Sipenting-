    ...
    <section className="data">
      <Container>
        ...
        <div className="d-flex justify-content-center gap-5">
          <Card className="text-center mb-3" style={{ width: "14rem", border: "1px solid black" }}>
            <Card.Body className="d-flex flex-column align-items-center">
              <Card.Img src="https://res.cloudinary.com/damsz0xlx/image/upload/v1683201270/Assets/data1_cl2jy3.png" alt="" style={{ maxWidth: "100px", maxHeight: "100px" }} className="mb-3" />
          ...
          <Card className="text-center mb-3" style={{ width: "14rem", border: "1px solid black" }}>
            <Card.Body className="d-flex flex-column align-items-center">
              <Card.Img src="https://res.cloudinary.com/damsz0xlx/image/upload/v1683201270/Assets/data2_ficqic.png" alt="" style={{ maxWidth: "100px", maxHeight: "100px" }} className="mb-3" />
          ...
          <Card className="text-center mb-3" style={{ width: "14rem", border: "1px solid black" }}>
            <Card.Body className="d-flex flex-column align-items-center">
              <Card.Img src="https://res.cloudinary.com/damsz0xlx/image/upload/v1683201270/Assets/data3_kjhtnn.png" alt="" style={{ maxWidth: "100px", maxHeight: "100px" }} className="mb-3" />
